...
import persistencia.InfoReader;
import persistencia.InfoWriter;
...
public class HumanPlayer extends TetrisPlayer implements Serializable {
    ...
    public HumanPlayer(String type) {
        ...
        if(!nickname.equals("")){
            String[] userInfo = InfoReader.getUserInfo(nickname, "UsersColors.txt");
            ...
            userInfo = InfoReader.getUserInfo(nickname, "UsersTopScores.txt");
            assert userInfo != null;
    ...
    public boolean hasLost(){
        ...
        if(lost && isBestScore()){
            InfoWriter.newRecord(nickname, getPoints());
        }
        return lost;
    }
